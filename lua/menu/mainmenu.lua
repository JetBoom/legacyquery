...
function ServerCallback( ping , name, desc, map, players, maxplayers, botplayers, pass, lastplayed, address, gamemode, workshopid )
	--legacyquery.GetServerInfo(string.match(address, "(.+):"), tonumber(string.match(address, ":(%d+)")))
	...
	local tocall = "AddServer( '"..typ.."', '"..refresh_id.."', "..ping..", \""..name.."\", \""..desc.."\", \""..map.."\", "..players..", "..maxplayers..", "..botplayers..", "..pass..", "..lastplayed..", \""..address.."\", \""..gamemode.."\", \""..workshopid.."\" )"
	pnlMainMenu:Call( tocall )
	print(tocall)
...
function GetServers( type, id )
	...
	legacyquery.GetMasterServerList(type, refresh_id)
end
